...
const bootstrap = async () => {
    ...
    app.listen(PORT, () => {
        ...
        const formattedTime = `${hours12.toString()}:${now.getMinutes().toString().padStart(2, '0')}:${now.getSeconds().toString().padStart(2, '0')} ${amPm}`;
        console.log(`\x1b[32m[Nest] ${process.pid}  - \x1b[37m${formattedDate}, ${formattedTime}     \x1b[32mLOG \x1b[33m[NestApplication] \x1b[32mNest application running on host: \x1b[34mhttp://localhost:${PORT}\x1b[37m`);
    });
}
bootstrap();
